...
export default function Admin() {
  ...
  const filteredStudents = students.filter(
    (s: any) =>
      ...
      s.primaryEmailAddress?.emailAddress
        ?.toLowerCase()
          ...
          <div className="flex justify-between items-center">
            ...
            >
              <DialogTrigger asChild>
                <Button>
                  <Plus className="mr-2 h-4 w-4" /> Nuova classe
                </Button>
              </DialogTrigger>
              <DialogContent>
                <DialogHeader>
                ...
                <div className="grid gap-4 py-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setNewClass((p) => ({
                            ...p,
                            anno: parseInt(e.target.value) || 1,
                          }))
                        }
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setNewClass((p) => ({
                            ...p,
                            sezione: e.target.value.toUpperCase(),
                          }))
                        }
                        maxLength={2}
                      />
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      value={newClass.indirizzo}
                      onValueChange={(v) =>
                        setNewClass((p) => ({ ...p, indirizzo: v }))
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
                  ...
                  <Button
                    onClick={() =>
                      createClass.mutate({
                        data: {
                          anno: newClass.anno,
                          sezione: newClass.sezione,
                          indirizzo: newClass.indirizzo,
                        } as any,
                      })
                    }
