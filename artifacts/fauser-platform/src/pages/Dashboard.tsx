    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Benvenuto nella piattaforma del Fauser. Ecco un riepilogo delle tue
          attività.
        </p>
      </div>
          ...
          <Card className="overflow-hidden relative group">
            ...
            <CardContent>
              <div className="text-3xl font-bold">
                {summary?.gradeAverage?.toFixed(1) || "-"}
              </div>
                ...
                <div className="space-y-4">
                  {summary.recentGrades.map((grade) => (
                    ...
                    >
                      ...
                      <div
                        className={`text-lg font-bold ${grade.value >= 6 ? "text-green-600" : "text-red-600"}`}
                      >
                        {grade.value}
                      </div>
                    </div>
        ...
        >
          <Card className="h-full">
            <CardHeader>
              ...
              <CardDescription>Compiti ed eventi imminenti</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex flex-col items-center justify-center py-12 text-center text-muted-foreground border-2 border-dashed rounded-lg">
                <Calendar className="h-8 w-8 mb-2 opacity-20" />
                <p>
                  Controlla la sezione Calendario per
                  <br />
                  vedere i tuoi prossimi impegni
                </p>
              </div>
            </CardContent>
          </Card>
